...
urlpatterns = [
    ...
    path('updateemployee/<str:empid>/', views.update_employee, name='update_employee'),
    ...
    path('update_hoken/<str:patid>', views.update_hoken, name='update_hoken'),
    ...
    path('prescription/<str:patid>/', views.treatment_list, name='treatment_list'),
    path('prescription/<str:patid>/add/', views.add_prescription, name='add_prescription'),
    path('prescription/<str:patid>/delete/<str:index>/', views.delete_prescription, name='delete_prescription'),
    path('prescription/<str:patid>/confirm/', views.confirm_prescription, name='confirm_prescription'),
    path('patient/<str:patid>/prescription/', views.patient_prescriptions, name='patient_prescriptions'),
